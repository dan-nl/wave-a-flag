...
(function( window, document ) {
	...
	window.lib = {
		...
		empty_console : { log : function() {}, error : function() {} },
...
(function( window, document, $ ) {
	...
	Wave = {
		 ...
		 * canvas, wavelength, amplitude, period, shading, squeeze
		 *
		...
		/**
		 * @param object options
		 * image_src, canvas_id, image_padding
		 */
		addWavableImage : function( options ) {
			...
			image.onload = function() {
				...
				*/
				...
				interval_timer = Wave.waveImage({ canvas : canvas });
	...
	function addWavableFlag() {
		...
		var flag = document.getElementById('wave-a-flag');
		flag.style.backgroundImage = 'url(flag-left.png)';
		flag.innerHTML = '<canvas id="flag-canvas" title="wave a flag"></canvas>';		
		
		try {
			
			Wave.addWavableImage({ image_src : 'flag-right.png', canvas_id: 'flag-canvas' });
